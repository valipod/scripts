...
JPEG_DATE_CMD="exiftool -n -overwrite_original_in_place -P '-DateTimeOriginal<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/\$1:\$2:\$3 \$4:\$5:\$6${TIMEZONE_OFFSET}/}' '-CreateDate<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/\$1:\$2:\$3 \$4:\$5:\$6${TIMEZONE_OFFSET}/}' '-ModifyDate<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/\$1:\$2:\$3 \$4:\$5:\$6${TIMEZONE_OFFSET}/}' '-SubSecTimeOriginal<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/defined \$8 ? \$8 : \"000\"/ee}' '-SubSecTimeDigitized<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/defined \$8 ? \$8 : \"000\"/ee}' '-SubSecTime<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/defined \$8 ? \$8 : \"000\"/ee}' -OffsetTime='${TIMEZONE_OFFSET}' -OffsetTimeOriginal='${TIMEZONE_OFFSET}' -OffsetTimeDigitized='${TIMEZONE_OFFSET}' ${JPEG_IF_CONDITION}"

# Set CreateDate for videos
# Use single quotes around the ExifTool substitution block to protect it from the outer shell
VIDEO_DATE_CMD="exiftool -n -overwrite_original_in_place -P '-DateTimeOriginal<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/\$1:\$2:\$3 \$4:\$5:\$6${TIMEZONE_OFFSET}/}' '-CreateDate<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/\$1:\$2:\$3 \$4:\$5:\$6${TIMEZONE_OFFSET}/}' '-ModifyDate<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/\$1:\$2:\$3 \$4:\$5:\$6${TIMEZONE_OFFSET}/}' '-SubSecTimeOriginal<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/defined \$8 ? \$8 : \"000\"/ee}' '-SubSecTimeDigitized<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/defined \$8 ? \$8 : \"000\"/ee}' '-SubSecTime<\${filename;s/^(\d{4})-(\d{2})-(\d{2})[ _]+(\d{2})-(\d{2})-(\d{2})(-(\d{3}))?.*/defined \$8 ? \$8 : \"000\"/ee}' -OffsetTime='${TIMEZONE_OFFSET}' -OffsetTimeOriginal='${TIMEZONE_OFFSET}' -OffsetTimeDigitized='${TIMEZONE_OFFSET}' ${VIDEO_IF_CONDITION}"
